...
DATA_BUCKET_NAME = "de-c4w4a2-268760403445-us-east-1-data-lake"
SCRIPTS_BUCKET_NAME = "de-c4w4a2-268760403445-us-east-1-scripts"
...
def deftunes_songs_pipeline():
    ...
    rds_extract_glue_job = GlueJobOperator(
        ...
        # The name of the Glue job created in Terraform. This corresponds to the value that you can find in the Terraform output with the key `glue_rds_extract_job`
        ...
        # The name of the IAM role deployed with Terraform and can be found in the Terraform output `glue_role_arn`.
        iam_role_name="Cloud9-de-c4w4a2-glue-role",
        s3_bucket=f"{SCRIPTS_BUCKET_NAME}",
        region_name="us-east-1",
        # Configuration settings for Glue
        create_job_kwargs={
            "GlueVersion": "3.0",
            "NumberOfWorkers": 2,
            "WorkerType": "G.1X",
    ...
    dq_check_songs_job = GlueDataQualityRuleSetEvaluationRunOperator(
        ...
        role="arn:aws:iam::268760403445:role/Cloud9-de-c4w4a2-glue-role",
